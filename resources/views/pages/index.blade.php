...
<header>
  ...
  <div class="container">
    ...
    <h1 class="my-4">What We Do At Aster Digital?</h1>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <img class="img-fluid rounded" src="img/5.jpg" alt="">
      </div>
    </div>
    <!-- /.row -->
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="posts/{{$post->id}}"><img class="img-fluid rounded" src="/storage/cover_images/{{$post->cover_image}}" alt="" style="width:100%"></a>
          <div class="card-body">
            <h4 class="card-title">
